...
function _hygroRender(d) {
  ...
  if (discEl) {
    ...
    if (!found.length) {
      discEl.innerHTML = '<span class="text-secondary small">Nothing new in range. Turn a sensor on nearby and it appears here.</span>';
    } else {
...
function _contactRender(d) {
  ...
  if (discEl) {
    ...
    if (!found.length) {
      discEl.innerHTML = '<span class="text-secondary small">Nothing new in range. Open or close a door with a sensor on it and it appears here.</span>';
    } else {
      discEl.innerHTML = found.map(dev => `<div class="d-flex align-items-center gap-2 small mb-1">
  ...
  if (discEl) {
    ...
    if (!found.length) {
      discEl.innerHTML = capturing
        ...
        : '<span class="text-secondary small">Nothing new heard. A button appears here right after you press it.</span>';
    } else {
