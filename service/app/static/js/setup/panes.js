...
function savePanePrinting(btn) {
  return savePane({
    printing_enabled:        chk('printing_enabled'),
    label_printer_queue:     optVal('label_printer_queue'),
    document_printer_queue:  optVal('document_printer_queue'),
...
async function loadPrintQueues(force) {
  ...
  try {
    ...
    ['label_printer_queue', 'document_printer_queue'].forEach(id => {
