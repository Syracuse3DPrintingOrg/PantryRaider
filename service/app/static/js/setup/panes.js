...
function _hygroRender(d) {
  ...
  if (discEl) {
    ...
    if (!found.length) {
      discEl.innerHTML = '<span class="text-secondary small">Nothing in range yet. ' + _GADGET_NO_RADIO_HINT + '</span>';
    } else {
  ...
  if (discEl) {
    ...
    if (!found.length) {
      discEl.innerHTML = capturing
        ...
        : '<span class="text-secondary small">Nothing heard yet. A button broadcasts only when pressed. ' + _GADGET_NO_RADIO_HINT + '</span>';
    } else {
