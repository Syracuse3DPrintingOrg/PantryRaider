...
async function saveDisplaySettings() {
  ...
  try {
    ...
    const saveResp = await (await fetch('setup/save', {
      method: 'POST', headers: {'Content-Type': 'application/json'},
      body: JSON.stringify({display_touch, display_type, display_idle_timeout, screensaver_minutes, screensaver_speed, screensaver_pill_scale, screensaver_mode, screensaver_photo_seconds, screensaver_ken_burns, screensaver_ken_burns_speed, screensaver_all_clients, osk_enabled, wake_on_motion}),
    })).json();
