...
async def start_page(request: Request):
    ...
    # Glance (the default): an auto-generated home built from the top-level nav
    # pages, large square buttons plus a row of notification pills. Custom keeps
    # the arrange-your-own launcher grid. (FoodAssistant-gg33)
    ...
    if glance:
        ...
        ctx["cols"] = cols
        ctx["rows"] = rows
        ctx["layout"] = sp.resolve_layout(settings.start_page_layout, keys, catalog=catalog)
