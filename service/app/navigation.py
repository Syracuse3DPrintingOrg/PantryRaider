...
NAV_TABS = [
    ...
    # Recipes, Cook, On the Line, and Meal Plan carry no service requirement:
    # the recipe library and meal plan are built in (Pantry Raider's own
    # store), so these pages work on every install, Mealie or not.
