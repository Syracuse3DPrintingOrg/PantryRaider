...
def led_palette(on_manage: bool) -> dict[str, tuple[int, int, int]]:
...
def build_outputs(mode_state: dict, alarms: list, timers: list,
    ...
    out = {
        ...
        "mode_colors": {m: list(c) for m, c in led_palette(on_manage).items()},
