...
def apply_defaults(item: FoodItem, db: Session, extra_match_text: str = "",
    ...
    # A rule (or the generic fallback) just filled a date that was missing:
    # that is a category-rule estimate, not something the user typed or an
    # AI worked out (FoodAssistant-cidz). Recorded to best_by_provenance.py
    # once the item lands in Grocy and a product id exists.
