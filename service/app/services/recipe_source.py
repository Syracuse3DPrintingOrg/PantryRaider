...
def active_backend() -> str:
    ...
    rule above now lives in integrations.recipes.resolve_active, and both
    backends are registered RecipeBackend inhabitants, so the registry is
    the single place that answers "which backend is live".
    """
    from ..integrations import registry
    return registry.active_name(registry.KIND_RECIPES)
