...
def add_warning(message: str, title: str = "", key: str = "",
                level: str = "warning", timeout: int = 0) -> int:
    ...
    tell one condition from another. Rides the same ring and since-id contract
    as everything else, so it degrades and shares across workers like the rest."""
