...
# Hosted mode and the memory-hungry features (local Ollama, Mealie). 4 GB
# boards report a little under 4096 MB once firmware reserves its slice, so the
# threshold sits below the round number on purpose.
MIN_HOSTED_RAM_MB = 3500
