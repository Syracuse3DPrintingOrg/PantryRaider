...
def test_extractor_finds_known_declarations():
    ...
    # _cubDevices joined with the Bandit Cubs section (FoodAssistant-mxof), so
    # the pin checks the identifiers rather than exact line numbers.
    assert set(decls) == {"_devicePairingPollTimer", "_cubDevices"}
    ...
    assert set(decls) == {
        ...
        "_WIZ_STASH_KEY", "_wizServerInvChecked",
    }
