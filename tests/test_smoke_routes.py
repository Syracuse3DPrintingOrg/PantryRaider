...
def test_floating_nav_renders_on_page(client):
    ...
    # /ui/ now leads to the Glance Start Page (a chrome-free home), so check the
    # nav on an actual content page (FoodAssistant-gg33).
...
def test_small_screen_nav_markup_present(client):
    ...
    """
    # /ui/ now leads to the chrome-free Glance Start Page, so check a content page.
