...
PINNED = {
    ...
    "pi_hosted": {
        "ids": [
            ...
            'streamdeck_key_style', 'streamdeck_rotation', 'streamdeck_screensaver_layout', 'streamdeck_weather_location',
    ...
    "pi_remote": {
        "ids": [
            ...
            'streamdeck_key_count', 'streamdeck_key_style', 'streamdeck_rotation', 'streamdeck_screensaver_layout',
            'streamdeck_weather_location', 'streamdeck_weather_units', 'suggest_per_tier', 'themealdb_api_key',
