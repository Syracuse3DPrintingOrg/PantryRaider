...
PINNED = {
    "server": {
        "ids": [
            ...
            'nav_visibility',
            # Added after the pin: the per-device persistent-submenu selector on
            # the Screen pane's On-screen navigation panel (FoodAssistant-ohro).
            'nav_persistent_device',
    ...
    "pi_hosted": {
        "ids": [
            ...
            'mealie_base_url', 'mealie_public_url', 'nav_visibility',
            # Added after the pin: the per-device persistent-submenu selector on
            # the Screen pane's On-screen navigation panel (FoodAssistant-ohro).
            'nav_persistent_device',
            'new_hostname',
