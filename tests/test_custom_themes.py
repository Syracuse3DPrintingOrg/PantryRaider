...
def _render(client, monkeypatch, *, is_pi: bool) -> str:
    ...
    # A settled install has a connected inventory (an API key). Without one, a
    # pi_hosted is held on the first-boot getting-ready page (the gate keys on
    # the key, not is_configured(), FoodAssistant-n2b4), and /setup would 302
    # there instead of rendering the settings panes this test inspects.
