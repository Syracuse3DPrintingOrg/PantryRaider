...
- **Kiosk screensaver**: a bouncing-logo or USB photo-slideshow screensaver with running timers floating along as countdown pills, and a switch to run it in every browser viewing the install; an attached Stream Deck shows the raccoon logo across its keys while the display sleeps
