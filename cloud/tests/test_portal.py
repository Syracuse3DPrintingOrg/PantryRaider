...
def test_landing_page(client):
    ...
    # The licence framing (PolyForm Noncommercial, not open source) and all
    # three pricing tiers show.
    assert "free for personal and non-commercial use" in resp.text
    assert "open source" not in resp.text
