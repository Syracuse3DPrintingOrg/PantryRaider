...
GATE_MESSAGE = ("Recipe upload is for kitchens actively using Pantry Raider. "
                ...
                "account. This gate exists only to keep spam and abuse out: "
                "if you would like uploads enabled, send us a short personal "
                "note from the email you signed up with and we will turn it "
                "on for you.")
