...
Open Settings, Thermometers & Sensors and find the **Hygrometers** section. A sensor
...
the "A fridge or door alarm takes over" switch in Settings, Bandit Remotes if you
...
They have their own section in Settings, Thermometers & Sensors, right under the
