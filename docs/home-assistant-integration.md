...
One other Home Assistant connection is separate from all of this and does not
change: the on-screen event toasts. Setting up the integration does not touch
them. Pantry Raider's own link to Home Assistant for camera feeds and Stream
Deck keys is now handled for you, as described under "Cameras and Stream Deck
connect on their own" above.
