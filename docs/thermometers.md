...
In Settings, Thermometers, open **From an ESP device**, type the device's
...
and **Ambient** (the pit or oven air around it). If the guess is wrong, or
you have moved a lead, you can override any probe to Internal, Ambient, or
Food.

## Targets, presets, and alerts on the Timers page

Day-to-day, your probes live on the Timers page, right alongside your kitchen
timers, and a toggle there lets you show just timers, just thermometers, or
both, remembering your choice. Each probe shows its current temperature in
big, kitchen-readable numbers with its battery state, and a low-battery badge
once it starts running down.
